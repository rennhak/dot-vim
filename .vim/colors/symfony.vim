...
syn match CommaDot display '[.,]'

hi Operators       ctermfg=Red  cterm=none
hi CommaDot       ctermfg=White
hi LineNr         ctermbg=Black  ctermfg=Green  cterm=none
hi MatchParen     ctermbg=Yellow ctermfg=8  cterm=none
...
" Fold
highlight Folded ctermfg=White ctermbg=248 guifg=#333333 guibg=DarkGrey
highlight FoldColumn ctermfg=Grey ctermbg=250 guifg=#333333 guibg=Grey
...
" Syntax group
highlight Comment ctermfg=245 guifg=#bd48b3
